    ...
    <>
      ...
      >
          ...
          >
            ...
            <ul data-thq="thq-dropdown-list" className="header-dropdown-list">
              <li data-thq="thq-dropdown" className="header-dropdown list-item">
                ...
                >
                  <span className="header-text01">{props.text1}</span>
                </div>
              </li>
              <li
                data-thq="thq-dropdown"
              ...
              >
                ...
                >
                  <span className="header-text02">{props.text2}</span>
                </div>
              </li>
              <li
                data-thq="thq-dropdown"
              ...
              >
                ...
                >
                  <span className="header-text04">{props.text4}</span>
                </div>
              </li>
              <li
                data-thq="thq-dropdown"
              ...
              >
                ...
                >
                  <span className="header-text10">{props.text10}</span>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div data-role="MobileMenu" className="header-mobile-menu">
          ...
          <div>
            <svg viewBox="0 0 950.8571428571428 1024" className="header-icon08">
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="header-icon12">
